...
// одинаковые числа
START_TEST(test_equal_or) {
  {
    // числа одинаковые, степень второго больше
    s21_decimal value_1 = {
        {3211110, 22, 0, 0b00000000000111000000000000000000}};
    s21_decimal value_2 = {
        {3211110, 22, 0, 0b00000000001111000000000000000000}};
    ck_assert_int_eq((s21_is_greater_or_equal(value_1, value_2)), 1);
  }
  {
    // числа разные, после нормализации 2е округляется
    s21_decimal value_1 = {{22981, 0, 0, 0b00000000000111000000000000000000}};
    s21_decimal value_2 = {{229803, 0, 0, 0b00000000000111010000000000000000}};
    ck_assert_int_eq((s21_is_greater_or_equal(value_1, value_2)), 1);
  }
  {
  ...
  }
  {
    ...
    s21_decimal value_1 = {{45971, 34532, 344159, MASK_MINUS}};
    s21_decimal value_2 = {{45971, 34532, 344159, MASK_MINUS}};
    ck_assert_int_eq((s21_is_greater_or_equal(value_1, value_2)), 1);
  }
  {
    // числа разные, знаки тоже
    s21_decimal value_1 = {{45097, 3453, 34415, 0}};
  ...
  }
  {
    ...
    s21_decimal value_1 = {{2322, 91, 875640, MASK_MINUS}};
    s21_decimal value_2 = {{2322, 91, 875640, MASK_MINUS}};
  ...
  }
  {
    ...
    s21_decimal value_2 = {
        {80000000, 0, 0, 0b00000000000001110000000000000000}};
    ck_assert_int_eq((s21_is_less_or_equal(value_1, value_2)), 1);
  }
  {
...
Suite *suite_s21_is_greater_or_equal_less() {
  ...
  tcase_add_test(tc, test_equal_or);
